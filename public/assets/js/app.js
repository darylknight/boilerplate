...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var formRows = document.querySelectorAll('form .flex');
  var formFields = document.querySelectorAll('form input');
  var formAreas = document.querySelectorAll('form textarea'); // https://css-tricks.com/a-bunch-of-options-for-looping-over-queryselectorall-nodelists/#aa-for-of

  var _iterator2 = _createForOfIteratorHelper(formButtons),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var button = _step2.value;
      button.classList.remove('bg-blue-500', 'hover:bg-blue-700', 'text-white', 'font-bold', 'py-2', 'px-4', 'rounded', 'mr-2');
  ...
  var _iterator3 = _createForOfIteratorHelper(formRows),
      _step3;
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      _row.classList.remove('mb-6');

      _row.classList.add('mb-2');
  ...
  var _iterator4 = _createForOfIteratorHelper(formFields),
      _step4;
  ...
  var _iterator5 = _createForOfIteratorHelper(formAreas),
      _step5;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkboilerplate_tailwind"] = self["webpackChunkboilerplate_tailwind"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./src/pcss/app.pcss")))
